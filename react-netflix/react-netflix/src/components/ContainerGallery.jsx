...
function ContainerGallery() {
  return (
    ...
    <Container fluid={true} className="mb-4">
        <Row>
            <Col xs={2} justify="middle">
                <h2 className="fs-1 fw-bold text-white mb-0">TV Shows</h2>
            </Col>
            ...
            <Col xs={9} className="d-flex justify-content-end align-items-center gap-5">
            <i className="bi bi-grid fs-3"></i>
            <i className="bi bi-grid-3x3 fs-3"></i>
            </Col>
        </Row>
      <Gallery galleryTitle="Trending Now"/>
      <Gallery galleryTitle="Watch Again"/>
      <Gallery galleryTitle="New Releases"/>
    </Container>
    </div>
    </>
  );
